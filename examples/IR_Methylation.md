...
## GSTP Methylation Data
  ...
  In Specific Aim I we will use our machine learning approach for systematic review to collect relevant papers.  A large corpus of papers relating to the Mesh Term Cancer forms the basis of aim 1. This large corpus is reduced to a more manageable set by human and machine labelling. The machine learning algorithm forms a large paper-paper similarity matrix. Human reviewers then label articles for the presence or absence of biomarker usage. Papers with a high degree of similarity to labeled papersThese labeled papers are used to predict biomarker labels for the unlabeled papers.  
