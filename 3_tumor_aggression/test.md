...
## Per Feature Aggression
 The table generated by `ClinicalOutcomes` provides a base dataset. To show per feature aggression via fishers combined statistics we start with a toy dataset. This toy dataset contains genes with high and low aggression numbers according to cancerregulome. It is built by ClinicalOutcomesRegulomeGenes:
