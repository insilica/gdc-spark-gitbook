...
We will use article text-mining and pathway-databases to relate biomarkers and pathways. In aim 1 humans will identify biomarker presence in papers. This presence requires a biomarker-synonym table whereby biomarkers can be uniquely identified. This synonym table allows identification of biomarkers in sentences. Human and machine review will manually and automatically identify biomarker relationships to biological entities. Named-Entity-Recognition aids in finding biomarker relationships to biological entities. These entities include proteins, genes, drugs, diseases and others.  The final step in this aim will insert biomarkers into the appropriate biological pathways.  Appropriate biological pathways will contain the biological entities measured by biomarkers.
