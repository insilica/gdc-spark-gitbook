...
## Per Feature Aggression
 The table generated by `ClinicalOutcomes` provides a base dataset. To validate and demonstrate our per-feature clinical aggression data we create a dataset from the cancer regulome.:
